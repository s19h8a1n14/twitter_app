...
const Home = () => {
  ...
  const sendOTP = (email) => {
    ...
    setOtp3("");
    setOtp4("");
    return axios.post(`http://localhost:5000/sendotp?email=${email}`, {
      email,
    });
  };
    ...
    return axios
      ...
      .then((res) => {
        ...
        if (res.data === "Verified") {
          setOpenModal(false);
          const response = axios.patch("http://localhost:5000/verifyDevice", {
            email: userEmail,
          });
  ...
  return check?.isOtpVerified === false ? (
    <div className="app">
    ...
    <div style={{ textAlign: "center", marginTop: "20px" }}>
      <h1 style={{ marginBottom: "20px" }}>
        You need to verify your device to tweet
      </h1>
